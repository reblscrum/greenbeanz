...
class Dashboard extends React.Component {
  ...
  render() {
    ...
    if (this.state.currentScreen === 'dashboard') {
      ...
      return <Cart shoppingList={this.props.shoppingList} finalQuery={this.state.finalQuery} query={this.props.query} walmart={this.props.walmart} heb={this.props.heb} wholeFoods={this.props.wholeFoods} changeScreen={this.changeScreen.bind(this)} 
